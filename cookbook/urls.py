...
from .views import RecipeDetailView, RecipeEditView, RecipeDeleteView, IngredientEditView, IngredientAddView, InstructionEditView, InstructionAddView, TagEditView, TagAddView
from . import views
